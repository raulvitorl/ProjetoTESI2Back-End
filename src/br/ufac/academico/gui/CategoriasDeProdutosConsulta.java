...
class CategoriasDeProdutosConsulta extends JFrame {
	...
	CategoriasDeProdutosConsulta(JFrame framePai, Conexao conexao){ // m√©todo construtor
		super("Consulta de Categorias de Produtos"); // chamando construtor da classe m√£e
		...
		cmbChaves = new JComboBox(new String[] {"Codigo", "Identificador","DescriÁ„o"});
